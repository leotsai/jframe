...
import org.jframe.core.unionpay.apiRequests.MobileWapPayRequest;
import org.jframe.core.unionpay.apiRequests.QueryOrderStatusRequest;
...
public class UnionpayApi {
    ...
    public String buildMobileWapPay(BigDecimal amount, String requestUuid) {
        MobileWapPayRequest request = new MobileWapPayRequest();
