...
import org.jframe.service.demo.RoleSettingService;
 ...
 */
@Controller
@RequestMapping("/demo/roleSetting")
public class RoleSettingController extends _DemoControllerBase {

    @Component
    public final class Codes implements PermissionDefinition {

        public final static String DICT = "demo-permissionDict-dict";
    ...
    public ModelAndView getPermissions(Long id) {
        return super.tryView("demo-roleSetting-permission", () -> {
