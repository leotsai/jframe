(function () {
    var urls = {
        ...
        findPassword: "/admin/findPassword/resetPassword"
    };
    ...
    $(document).ready(function () {
        ...
        $btnSendSms.click(function () {
            ...
            var data = "captcha=" + imgCaptcha + "&phone=" + phone + "&usage=RESET_PASSWORD";
    ...
    function doReset() {
        ...
        mvcApp.ajax.busyPost(urls.findPassword, data, function (result) {
