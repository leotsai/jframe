(function () {
    ...
    var urls = {
        ...
        add: "/admin/employee/edit",
        detail: "/admin/employee/detail",
        addDepartment: "/admin/department/save",
        ...
        getPermissions: function getPermissions(id) {
            return "/admin/roleSetting/getPermissions?id=" + id;
        },
        permissionDict: "/admin/permissionDict",
        superAdmin: "/admin/adminSetting",
        getSuperAdminCount: "/admin/employee/getSuperAdminCount",
        getDepartmentEmployeeCount:"/admin/department/getDepartmentEmployeeCount"
